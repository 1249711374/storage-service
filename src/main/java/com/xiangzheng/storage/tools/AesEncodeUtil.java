...
public class AesEncodeUtil {
    //偏移量
    public static final String VIPARA = "da39a3ee5e6b4b0d3255bfef95601890afd80709";   //AES 为16bytes. DES 为8bytes
    ...
    //私钥
    private static final String AES_KEY="xiangzhengkeji01";   //AES固定格式为128/192/256 bits.即：16/24/32bytes。DES固定格式为128bits，即8bytes。
...
//        test(content);
//        String company = "xiangzhengkeji";
//        String encodeStr = "";
//        System.out.println(encrypt(company));
//        encodeStr = encrypt(company);
       // System.out.println(decrypt("X8D7KA0kuXOtorkPCxkZ3A=="));
//        System.out.println(OutIdUtils.DBId(new Random().nextInt(1000000)));
    }
