...
public class Hashids {
    ...
    // 图片Hashid生成
    public static final String ALPHABET_1 = "abcdefghijklmnopqrstuvwxyz1234567890";
    public static final String SALT_1 = "xz-aliyunoss-upload";
    ...
    public static final String DEFAULT_SEPS = "cfhistuCFHISTU";
    public static final String DEFAULT_SALT = "4114e76317b28afcc68297273ff7e0f321261c2e";

    public static final int DEFAULT_MIN_HASH_LENGTH = 0;
    public static final int MIN_ALPHABET_LENGTH = 16;
    public static final double SEP_DIV = 3.5;
    public static final int GUARD_DIV = 12;

    public final String salt;
    public final int minHashLength;
    public final String alphabet;
    public final String seps;
